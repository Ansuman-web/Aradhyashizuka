...
'''
    HELP_ALLBOT = '''
**───────────────────────
│ ᴡєʟᴄσϻє ᴛσ ˹[˹𝘼𝙧𝙖𝙙𝙝𝙮𝙖 ✘ 𝐌ᴜꜱɪᴄ˼🎐](https://t.me/ZEUS_music_robot)˼ ʙσᴛ sᴛᴧᴛυs │
───────────────────────
...
───────────────────────
⊚ ʟᴧsᴛ ᴄʜєᴄᴋєᴅ ση : ᴅᴧᴛє : 01 Jan 2025 
───────────────────────
❍ ᴘσᴡєʀєᴅ ʙʏ ⁚ ˹ [ᴢᴇᴜꜱ](https://t.me/unbornedvillian) ˼
───────────────────────**
'''
    HELP_ABOUT = '''
**───────────────────────
...
● ᴧɪ ɪηᴛєɢʀᴧᴛɪση
───────────────────────
❖ υᴘᴅᴧᴛєs ᴄʜᴧηηєʟ ➥ [ʙᴏᴛ ᴄʜᴀᴍʙᴇʀ](https://t.me/ll_botchamber_ll)
❖ ʀєᴧʟ σᴡηєʀ ➥ [ᴢᴇᴜꜱ](https://t.me/unbornedvillian)
───────────────────────
