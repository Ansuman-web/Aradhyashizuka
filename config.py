...
LOGGER_ID = int(getenv("LOGGER_ID", -1001934970018))
OWNER_ID = int(getenv("OWNER_ID", 7692605600))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Ansuman-web/Aradhyashizuka",)
